...
tics_adjusted_model <- jags.model(textConnection(tics_adjusted_model_bugs), data=tics_baseline_dataset, n.adapt=1000)
tics_adjusted_model_gibbs <- update(tics_adjusted_model, n.iter=1000)
tics_adjusted_model_test <- coda.samples(tics_adjusted_model, c("beta0", "beta_group", "beta_sex", "beta_bmi", "beta_smoker", "beta_aspirin", "beta_stroke", "beta_diabetes", "beta_hypertension", "beta_cad"), n.iter=1000)
